package com.phincon.backend.bootcamp.marketplace.order_service.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    public Mono<ErrorResponse> handleOrderItemNotFoundException(OrderItemNotFoundException ex) {
